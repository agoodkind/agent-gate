...
const (
	Inference_Infer_FullMethodName = "/inference.v1.Inference/Infer"
)
...
func (c *inferenceClient) Infer(ctx context.Context, in *InferRequest, opts ...grpc.CallOption) (*InferReply, error) {
...
func (UnimplementedInferenceServer) Infer(context.Context, *InferRequest) (*InferReply, error) {
...
var Inference_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "inferencepb/inference.proto",
}
